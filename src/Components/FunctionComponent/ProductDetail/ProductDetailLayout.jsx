...
//
import Breadcrumbs from '../../SupportComponent/Breadcrumb/Breadcrumbs';
...
const ProductDetailLayout = ({
    ...
    return (
        <div
            className='ProductDetailLayout'
            style={productDetail.length < 1 ? { textAlign: 'center' } : null}
        >
            {productDetail.length !== 0 && <Breadcrumbs />}
            {productDetail.length === 0 ? (
                ...
                <div className='ProductDetailLayout__Box container'>
                    ...
                    <div className='ProductDetailBox__Description'>
                        <b>Description:</b> Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Rerum qui vel molestias
                        aspernatur omnis saepe impedit laboriosam, soluta
                        laudantium doloremque! Amet dolores maiores possimus
                        veniam ea quas hic aperiam modi!
                    </div>
                    <div className='ProductDetailBox__Rating'>Rating: 4/5</div>
                    ...
                    <div className='ProductDetailBox__AddToCart'>
                        ...
                        <input
                            ...
                            autoComplete='off'
                            onChange={(event) => {
                                let newAmount = Math.round(event.target.value);
                                if (newAmount < 1) {
                                    newAmount = 1;
                                } else if (!isNaN(newAmount)) {
                                    newAmount = Math.round(event.target.value);
                                }
