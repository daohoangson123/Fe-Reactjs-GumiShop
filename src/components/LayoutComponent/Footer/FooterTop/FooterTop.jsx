    ...
    return (
        <div className='FooterTop container'>
            <div className='FooterTop_Item1'>
                <div className='NavBar__Logo FooterTop_Item1-Logo'>
                    GOOD<span>4</span>ME
                </div>
                <p className='FooterTop_Item1-content'>
            ...
            <div className='FooterTop_Item2'>
                ...
                <p className='FooterTop_Item2-content'>
                    Subscribe to receive new product updates, be the first to
                    know about sales, and more.
                </p>
                <form
                    action=''
                    className='FooterTop_Item2-form'
                >
                    <input
                        autoComplete='off'
                        type='email'
